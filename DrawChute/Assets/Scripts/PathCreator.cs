...
public static class PathCreator
{
    ...
    public static List<Vector2> Path(float gap, List<Vector2> mousePath)
    {
        ...
        while (index < mousePath.Count - 1)
        {
            ...
            var distance = Vector2.Distance(referencePoint, mousePath[index + 1]);
            ...
            referencePoint = mousePath[index + 1];
            index++;
        }
